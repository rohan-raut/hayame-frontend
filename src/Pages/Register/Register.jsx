...
const Register = () => {
  ...
  const validatePassword = (password) => {
    ...
    showAlert(
      "Password should contain characters between 6 to 20 which contain at least one numeric digit, one uppercase and one lowercase letter",
      "danger"
    );
    return false;
  };
          ...
          <form onSubmit={handleRegister}>
            <div className="row">
              <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                <label for="firstName" class="form-label register-input-label">
                  First Name
                </label>
                <input
                  type="text"
              ...
              <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                <label for="lastName" class="form-label register-input-label">
                  Last Name
                </label>
                <input
                  type="text"
            ...
            <div className="row">
              <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <input
                  type="email"
                  value={registerInputs.emailAddress || ""}
                  onChange={handleChange}
                  class="form-control register-input-field"
                  id="email"
                  name="emailAddress"
            ...
            <div className="row">
              <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                <label for="password" class="form-label register-input-label">
                  Password
                </label>
                <input
                  type="password"
            ...
            <button
              type="submit"
              name="submit"
              className="btn register-input-submit"
              id="register-btn"
            >
              Register
            </button>
